...
generator = GLE_Estimator(verbose=1, dim_x=dim_x, dim_h=dim_h, EnforceFDT=True, force_init=[-1], init_params="random", model=model)
X, idx, Xh = generator.sample(n_samples=5000, n_trajs=1, x0=0.0, v0=0.0, basis=basis)
